...
describe 'NumberRectangle', ->
  describe 'constructor', ->
    it 'should set the number to 0 and width to 0', ->
      ...
      rectangle.number.should.equal 0
  ...
  describe 'addDigit', ->
    it 'should update the number and width', ->
      ...
      rectangle.number.should.equal 5
      rectangle.width.should.equal 1

describe 'SymbolRectangle', ->
  describe 'constructor', ->
    it 'should set the symbol and dimensions', ->
      rectangle = new SymbolRectangle('X', 4, 5)
      rectangle.symbol.should.equal 'X'
      rectangle.x.should.equal 3
      rectangle.y.should.equal 4
      rectangle.width.should.equal 3
      rectangle.height.should.equal 3
{ expect } = require 'chai'
